...
const RestoranInfo = ({ restoran }: resProp) => {
  ...
  return (
    <div className="info p-10 bg-slate-300/50 dark:bg-slate-300/40 w-full h-full rounded-b-lg ">
      ...
      <div className="flex-between2 gap-2 pt-2 sm:flex-row flex-col relative ">
        <div className="flex-1  bg-slate-300/50 p-1 min-w-full sm:min-w-0 relative">
          <button
            className="dark:text-white text-lg w-full hover:bg-white/60 dark:hover:bg-slate-500/60 transition-all p-2"
            onClick={() => {
              if (openState === 2) {
                setOpenState(0);
              } else {
          ...
          {openState === 2 && (
            <div className="sm:absolute relative left-0   w-full  p-2 pt-0  rounded-b-lg dark:bg-[#9199A7] bg-[#d5dce3] shadow-md">
        ...
        <div className="flex-1 bg-slate-300/50 p-1 min-w-full sm:min-w-0 relative">
          ...
          {openState === 1 && (
            <div className="sm:absolute relative left-0   w-full  p-2 pt-0  rounded-b-lg dark:bg-[#979FAA] bg-[#d5dce3]/90 shadow-md">
        ...
        <div className="flex-1 bg-slate-300/50 p-1 min-w-full sm:min-w-0 relative">
          ...
          {openState === 3 && (
            <div className="sm:absolute relative left-0 w-full p-2 pt-0 rounded-b-lg dark:bg-[#929CA5] bg-[#d5dce3] shadow-md">
